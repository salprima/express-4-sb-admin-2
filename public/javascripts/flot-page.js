require.config({
    ...
    'canvas': '/lib/flot-charts/excanvas',
    'flot':'/lib/flot-charts/jquery.flot',
    'flot.pie':'/lib/flot-charts/jquery.flot.pie',
    'flot.resize':'/lib/flot-charts/jquery.flot.resize',
    'flot.time':'/lib/flot-charts/jquery.flot.time',
    'flot.tooltip': '/static/javascripts/jquery.flot.tooltip'
	},
	shim: {
		'jquery'    : { exports: '$' },
    'bootstrap' : { deps: ['jquery'], exports: 'bootstrap'},
    'canvas': {deps: ['jquery']},
    'flot': {deps: ['jquery'], exports: 'flot'},
    'flot.pie': {deps: ['jquery'], exports: 'flotPie'},
    'flot.resize':{ deps: ['jquery'], exports: 'flotResize'},
    'flot.time': {deps: ['jquery'], exports: 'flotTime'},
    'flot.tooltip': {deps: ['jquery'], exports: 'flotTooltip'}

	}
});

//Line Chart
define ('lineChart', ['flot.tooltip','flot.resize'], function () {
...
//Pie Charts
define ('pieChart', ['flot.pie','flot.tooltip'], function () {
  return function(){
...
define ('euroFormatter', [], function () {
  return function (v, axis) {
      return v.toFixed(axis.tickDecimals) + "€";
  };
});

define ('multiAxisChart', ['euroFormatter','flot.time','flot.tooltip'], function (euroFormatter) {
...
define('movingLineChart',[],function(){
...
//Flot Bar Chart
define('barChart',['flot.tooltip'], function(){
  return function(){
    var barOptions = {
        series: {
            bars: {
...
require(['jquery', 'bootstrap', 'flot', 'lineChart', 'multiAxisChart', 'pieChart', 'movingLineChart', 'barChart'],
function($, bootstrap, flot, lineChart, multiAxisChart, pieChart,movingLineChart,barChart){
  ...
  //Multi Axes Chart
  multiAxisChart("right");
  $("button").click(function() {
      multiAxisCharts($(this).text());
  });
